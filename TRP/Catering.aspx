...
<asp:Content ID="contentCatering" ContentPlaceHolderID="MasterContent" runat="server">
    ...
    <div class="container">
        <div class="form-group">
            ...
            <div class="row">
                <div id="myCarousel1" class="carousel slide col-sm-4" data-interval="2000" data-ride="carousel" 
                    style="width: 400px; height: 100px; padding-left:100px">
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="pics/fingerfoods.jpg" class="img-responsive" />
                            <!--<div class="carousel-caption"></div>-->
                            <h5>Finger Foods</h5>
                            <h6>Option 1</h6>
                        </div>
                        <div class="item">
                            <img src="pics/Seafood.jpg" class="img-responsive" />
                            <div class="carousel-caption"></div>
                            <h5>Seafood</h5>
                            <h6>Option 2</h6>
                        </div>
                        <div class="item">
                            <img src="pics/BBQ.jpg" class="img-responsive"/>
                            <!--<div class="carousel-caption"></div>-->
                            <h5>BBQ</h5>
                            <h6>Option 3</h6>
                        </div>
                        <div class="item">
                         <img src="pics/ItalianFood.jpeg" class="img-responsive" />
                            <!--<div class="carousel-caption"></div>-->
                            <h5>Italian</h5>
                            <h6>Option 4</h6>
                        </div>
                        <div class="item">
                            <img src="pics/Chipotle.jpg" class="img-responsive" />
                            <!--<div class="carousel-caption"></div>-->
                            <h5>Chipotle</h5>
                            <h6>Option 5</h6>
                        </div>
